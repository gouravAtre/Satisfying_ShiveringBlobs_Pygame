...
class BlueBlob(Blob):
    ...
    def __add__(self, other_blob):
        if other_blob.color == (255, 0, 0):
            ...
            raise Exception('Tried to combine one or multiplw blobs of unsupported colors.')
            ...
            for other_blob_id, other_blob in other_blobs.copy().items():
                if blue_blob == other_blob:
                    ...
                    if is_touching(blue_blob, other_blob):
                        ...
                        if other_blob.size <= 0: del other_blobs[other_blob_id]
                        if blue_blob.size <= 0: del blues[blue_id]
